/**
 * Static India country -> state -> district reference data used to power
 * cascading location pickers (e.g. the Vidhan Sabha form). This is UI-only
 * reference data - it is never sent to the backend as-is, only the final
 * state/district string values are persisted.
 */
...
export const DISTRICTS_BY_STATE: Record<string, string[]> = {
  ...
  Punjab: [
    ...
    "Fazilka", "Firozpur", "Gurdaspur", "Hoshiarpur", "Jalandhar", "Kapurthala",
    "Ludhiana", "Malerkotla", "Mansa", "Moga", "Muktsar", "Pathankot",
    "Patiala", "Rupnagar", "Sangrur", "SAS Nagar (Mohali)", "Tarn Taran",
  ],
  Haryana: [
...
export const getDistrictOptions = (state?: string) => {
